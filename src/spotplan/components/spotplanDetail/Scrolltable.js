...
import "../../../components/Scolltable.css";
...
class Scolltable extends React.Component {
  ...
  componentDidMount() {
    ...
    this.hiddenScroll = document.getElementsByClassName(nameTrue)[num];
    //在低部的滚动条
    this.bottomScroll = document.getElementsByClassName('top')[num];
    //监听滚动条
