...
<div class="container braft-output-content"><h2 class="header-title">${title}</h2><header class="header-author"><p>${author}</p></header><blockquote style="display: ${remark ? 'block' : 'none'}"><section>${remark}<section></blockquote>${content}</div></body></html>
    `
