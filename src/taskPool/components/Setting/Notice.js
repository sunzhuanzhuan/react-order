...
const Notice = (props) => {
  const handleDelete=(record)=>{
    ...
    confirm({
      title: '删除人员',
      content: `确定要在通知列表中${record.address6}删除么？`,
      okText: '确定',
      okType: 'danger',
      cancelText: '取消',
      onOk() {
  ...
  return (
    <div>
      ...
      <div style={{ marginLeft: '30px' }}>
        ...
        <Table dataSource={[{ "address6": 1 }, {}, {}, {}, {}, {}]} columns={columns} pagination={false}/>
        <h3 style={{ margin: '10px 0' }}>质检异常短信通知 <Button type="primary">添加人员</Button></h3>
        <Table dataSource={[{ "address6": 2 }, {}, {}, {}, {}, {}]} columns={columns} pagination={false} />
      </div>
    </div>
  );
};
